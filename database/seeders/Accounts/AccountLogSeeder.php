...
class AccountLogSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $account_log->amount = "debit";
        $account_log->decription = "monthly office rent";
        ...
        $account_log->amount = "debit";
        $account_log->decription = "monthly office current bill";
        $account_log->is_income = 0;
        $account_log->is_expense = 1;
        $account_log->save();
